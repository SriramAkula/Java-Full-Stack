...
public class AccountDao {
	...
	public double displayBalance(long accountNumber) {
	    ...
	    try {
	        AccountBean bean = session.get(AccountBean.class, accountNumber);
	...
	public void depositMoney(long accNo, double amount) {
	    ...
	    try {
	        ...
	        AccountBean bean = session.get(AccountBean.class, accNo);
	...
	public void fundTransfer(long accNo1, long accNo2, double amount) {
	    ...
	    try {
	        ...
	        AccountBean bean1 = session.get(AccountBean.class, accNo1);
	        AccountBean bean2 = session.get(AccountBean.class, accNo2);
	        ...
	        trans1.setTransaction("Funds transferred to " + accNo2);
	        ...
	        trans2.setTransaction("Funds received from " + accNo1);
	...
	public List<TransactionBean> printTransactions(long accNo) {
	    ...
	    List<TransactionBean> statements = session
	            .createQuery("from TransactionBean where accountNumber = :no order by date desc")
